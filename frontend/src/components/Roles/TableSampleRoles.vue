...
<template>
  ...
  <table>
    <thead>
      ...
      <th
        :class="['sortable uppercase text-sm font-normal text-pavitra-600', props.sortTitle === 'roleName' && props.sortDirection]"
        @click="sort('roleName')"
      >Role Name</th>

      <th
        :class="['sortable uppercase text-sm font-normal text-pavitra-600', props.sortTitle === 'permission' && props.sortDirection]"
        @click="sort('permission')"
      >Permission</th>
