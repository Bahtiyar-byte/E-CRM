...
{ text: 'Assigned User ', value: 'assigned_userId'},
{ text: 'Assigned Team ', value: 'assignedTeamId'},
...
<template>
  ...
  <table>
    <thead>
      ...
      <th
        :class="['sortable uppercase text-sm font-normal text-pavitra-600', props.sortTitle === 'assigned_userId' && props.sortDirection]"
        @click="sort('assigned_userId')"
      >Assigned User </th>

      <th
        :class="['sortable uppercase text-sm font-normal text-pavitra-600', props.sortTitle === 'assignedTeamId' && props.sortDirection]"
        @click="sort('assignedTeamId')"
      >Assigned Team </th>
    ...
    <tbody>
      ...
      >
        ...
        />
              ...
              <td data-label="assigned_userId">
                  <span
                    v-for="(i, idx) in dataFormatter.usersManyListFormatter(client.assigned_userId)"
                    :key="idx + client.assigned_userId"
                    class="block"
                  >
                      {{ i }}
                  </span>
              ...
              <td data-label="assignedTeamId">
                  <span
                    v-for="(i, idx) in dataFormatter.teamsManyListFormatter(client.assignedTeamId)"
                    :key="idx + client.assignedTeamId"
                    class="block"
                  >
                      {{ i }}
                  </span>
