...
{ text: 'Measurement', value: 'unitOfMeasurement'},]
...
<template>
  ...
  <table>
    <thead>
      ...
      <th
        :class="['sortable uppercase text-sm font-normal text-pavitra-600', props.sortTitle === 'material' && props.sortDirection]"
        @click="sort('material')"
      >Material</th>
      ...
      <th
        :class="['sortable uppercase text-sm font-normal text-pavitra-600', props.sortTitle === 'Labor' && props.sortDirection]"
        @click="sort('Labor')"
      >Labor</th>
